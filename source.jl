...
function call(obj::SRC0, xy::AbstractVector, f::AbstractArray)
    f[:] = 0.0
    return nothing
end
...
function call(obj::SRC1, xy::AbstractVector, f::AbstractArray)
    f[:] = 1.0
    return nothing
end
...
function call(obj::SrcTrigPoly2ndDiffn, xy::AbstractVector, src::AbstractArray)
    n = 2.0
...
function call(obj::SrcTrigPoly6thDiffn, xy::AbstractVector, src::AbstractArray)
    n = 2.0
	sc = sin(2*n*pi*xy[1])*cos(2*n*pi*xy[2])
	cs = cos(2*n*pi*xy[1])*sin(2*n*pi*xy[2])
	ss = sin(2*n*pi*xy[1])*sin(2*n*pi*xy[2])
...
function call(obj::SrcTrigPoly0thDiffn, xy::AbstractVector, src::AbstractArray)
    n = 2.0
...
function call(obj::SrcPoly2nd, xy::AbstractVector, src::AbstractArray)
	a = 1.0
	b = 1.0
	c = 1.0
