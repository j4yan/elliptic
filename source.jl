...
type SrcTrigPoly2ndDiffnSlightUnsteady <: SRCType
end
function call(obj::SrcTrigPoly2ndDiffnSlightUnsteady, 
              xy::AbstractVector, 
              src::AbstractArray,
              t=0.0)
  n = 1.0
...
type SrcTrigPoly2ndDiffnSlightUnsteady3 <: SRCType
end
function call(obj::SrcTrigPoly2ndDiffnSlightUnsteady3, 
              xy::AbstractVector, 
              src::AbstractArray,
              t=0.0)
  src[1] = 0.0
...
global const SRCDict = Dict{ASCIIString, SRCType}(
 ...
 "SrcTrigPoly2ndDiffnSlightUnsteady3" => SrcTrigPoly2ndDiffnSlightUnsteady3(),
